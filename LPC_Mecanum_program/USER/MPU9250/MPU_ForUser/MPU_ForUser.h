...
//			MAG_Real;			//磁力计滤波以后的数据
		...
		float	
			...
			Roll,			//翻滚角原始值
			Yaw,			//偏航角原始值
			Yaw_Save,		//保存当前角度的偏航角原始值
		
			Yaw_MapZero,   //校准后得到的，相对地图方向角
			Yaw_MapZero_Save, //保存车头相对地图方向角,即此时车头相对地图y轴的偏角
		
			Yaw_HeadZero,		//相对车头偏航角
			Yaw_HeadZero_Aid,	//相对车头偏航角目标值
