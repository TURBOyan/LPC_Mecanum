...
//	LCD_ShowString(0,20,176,16,16,"MPU6500:ID=");
//	LCD_ShowxNum(90,20,res,3,16,0);//显示MPU6500的ID
...
//	LCD_ShowString(0,40,160,16,16,"AK8963 :ID=");
//	LCD_ShowxNum(90,40,res,3,16,0);//显示AK89630的ID
